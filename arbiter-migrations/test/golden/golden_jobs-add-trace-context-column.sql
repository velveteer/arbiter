...
ALTER TABLE "arbiter"."golden_jobs_archive" ADD COLUMN IF NOT EXISTS traceparent TEXT;
ALTER TABLE "arbiter"."golden_jobs_archive" ADD COLUMN IF NOT EXISTS tracestate TEXT;
