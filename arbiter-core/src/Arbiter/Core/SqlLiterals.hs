...
-- string interpolation for statements that cannot use parameter binding, such
-- as migrations and seed upserts.
...
-- @Infinity@\/@NaN@ parse without an invalid statement.
